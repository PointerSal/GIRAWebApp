...
<head>
  ...
  <style>
    ...
    body::before, body::after { display: none; } /* disabilita griglia landing */
    ...
    .topbar-badge--medico  { background: var(--blue);  color: var(--bg); }
    .topbar-badge--utente  { background: var(--muted); color: var(--bg); }
    ...
    .topbar-esci:hover { border-color: var(--red); color: var(--red); }
    ...
    .pwa-install { display: none; margin-bottom: var(--space-md); }
    ...
    .mob-drawer .nav-sezione { padding: var(--space-md) var(--space-lg) var(--space-xs); }
    ...
    .mob-drawer-footer a { color: var(--red) !important; border-left: none !important; }
